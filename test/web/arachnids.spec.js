...
describe('/', function () {
  ...
  it('should get arachnids', function () {
    return agent.get('/arachnids').expect(200).then(data => {
      data.text.includes('Arachnids').should.be.true()
    })
  })

  it('should get an arachnid', function () {
    return agent.get('/arachnids/123').expect(200).then(data => {
      data.text.includes('Arachnid').should.be.true()
    })
  })
